...
AVAI_SAMPLERS = [
    ...
    'RandomDomainSampler', 'RandomDatasetSampler', 'DistributedSampler',
    'InferenceSampler'
]
...
def build_train_sampler(
    ...
    **kwargs
    ...
    elif train_sampler == 'DistributedSampler':
        DDPsetup()
        sampler = torch.utils.data.distributed.DistributedSampler(dataset=data_source)
