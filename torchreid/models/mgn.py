# https://github.com/GNAYUOHZ/ReID-MGN/blob/master/network.py
import copy
import torch
...
class MGN(nn.Module):
    def __init__(self, num_classes, loss, backbone):
...
def mgn(num_classes, loss='softmax', pretrained=True, **kwargs):
