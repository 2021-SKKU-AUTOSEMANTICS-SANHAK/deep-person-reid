...
def efficientnet(num_classes, loss='softmax', pretrained=True, **kwargs):
    model = EfficientNet(
    ...
    model = Backbone(
        ...
        model_path='weights_efficientnetv2_market/weights_efficientnetv2_market/efficientnet_v2_model_45.pth',
